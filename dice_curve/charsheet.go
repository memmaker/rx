...
func (c *Character) DetailInfo() []string {
    ...
    rows := fxtools.TableLayout([]fxtools.TableRow{
        {Columns: []string{
    ...
    }, []fxtools.TextAlignment{fxtools.AlignLeft, fxtools.AlignLeft, fxtools.AlignLeft, fxtools.AlignLeft, fxtools.AlignLeft, fxtools.AlignLeft})
    ...
    skillRows := fxtools.TableLayout([]fxtools.TableRow{
    ...
    }, []fxtools.TextAlignment{fxtools.AlignLeft, fxtools.AlignLeft, fxtools.AlignLeft, fxtools.AlignLeft})
